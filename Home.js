...
const MyTabs = () => {
    return(
        <Tab.Navigator screenOptions={{tabBarActiveTintColor:'red'}}>
            ...
            />
            <Tab.Screen name='Pedidos' component={Producto} 
            options={{
                tabBarLabel: 'Pedidos',
                tabBarIcon: ({color, size}) => (
            ...
            />
            <Tab.Screen name='Pedir Balon' component={PedirBalon} 
            options={{
...
const PedirBalonNavigator = () => {
    return(
        <Stack.Navigator screenOptions={screenOptionsStyle}>
            <Stack.Screen name='Pedir Balon' component={MyTabs}></Stack.Screen>
            <Stack.Screen name='Detail' component={Detail}></Stack.Screen>
        </Stack.Navigator>
    )
}

export default PedirBalonNavigator;